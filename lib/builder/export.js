...
function bundle(project, version) {
  ...
  let shell = read("views/build/host.html")
    ...
    .replaceAll("/build/assets/wallets.js", "wallets.js")
    .replaceAll("/build/assets/qrcode.js", "qrcode.js")
    .replaceAll("/build/assets/host.js", "host.js")
    .replace(
      '<script src="kondor.min.js"',
      '<script src="koinos.min.js" defer></script><script src="wallet-proof.js" defer></script><script src="kondor.min.js"',
    )
  ...
  const files = {
    ...
    "site/wallets.js": read("views/build/wallets.js"),
    "site/wallet-proof.js": read("lib/builder/wallet-proof.js"),
    "site/qrcode.js": read("views/build/vendor/qrcode.js"),
    "site/qrcode-LICENSE.txt": read("views/build/vendor/qrcode-LICENSE.txt"),
